...
func TestCalculate_EF_Grade4(t *testing.T) {
	...
	for _, tc := range cases {
		result := Calculate(tc.startEF, 0, 0, 4)
...
func TestValidateGrade_ErrorMessage(t *testing.T) {
	...
	expected := "invalid grade: 2, must be 0, 3, 4, or 5"
...
func TestCalculate_FullLifecycle(t *testing.T) {
	...
	r2 := Calculate(r1.EaseFactor, r1.Interval, r1.Repetitions, 4)
	...
	r3 := Calculate(r2.EaseFactor, r2.Interval, r2.Repetitions, 4)
	...
	r4 := Calculate(r3.EaseFactor, r3.Interval, r3.Repetitions, 0)
	...
	r5 := Calculate(r4.EaseFactor, r4.Interval, r4.Repetitions, 5)
...
func checkNextReview(t *testing.T, nextReview string, expectedInterval int) {
	t.Helper()
	...
	now := time.Now().UTC()
	expectedDate := now.AddDate(0, 0, expectedInterval)
