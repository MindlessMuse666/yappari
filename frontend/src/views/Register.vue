      ...
      <form @submit.prevent="handleRegister" class="auth-form">
        ...
        <div class="input-group">
          ...
          <InputText id="password" v-model="password" type="password" placeholder="Минимум 6 символов"
            class="custom-input" :class="{ 'input-error': error }" autocomplete="new-password" />
        </div>
        <div class="input-group">
          <label for="confirm-password">Подтверждение пароля</label>
          <InputText id="confirm-password" v-model="confirmPassword" type="password" placeholder="Повторите пароль"
            class="custom-input" :class="{ 'input-error': error }" autocomplete="new-password" />
        </div>
